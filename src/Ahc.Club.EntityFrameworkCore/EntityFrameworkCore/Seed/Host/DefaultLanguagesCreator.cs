...
namespace Ahc.Club.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = ExchangeConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
            return new List<ApplicationLanguage>
            {
                new ApplicationLanguage(tenantId, "en", "English", "famfamfam-flags us"),
                new ApplicationLanguage(tenantId, "ar-SY", "العربية", "famfamfam-flags sa"),
        ...
        public DefaultLanguagesCreator(ExchangeDbContext context)
        {
            _context = context;
        }

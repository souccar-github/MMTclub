...
import { API_BASE_URL, XxxServiceProxy } from '@shared/service-proxies/service-proxies';
...
import { CreateXxxDialogComponent } from './create-xxx/create-xxx-dialog.component';
import { EditXxxDialogComponent } from './edit-xxx/edit-xxx-dialog.component';
...
export class XxxComponent extends AppComponentBase implements OnInit {
  // Grid
  @ViewChild('xxxGrid') public grid: GridComponent;
  public xxxs: DataManager;
  ...
  constructor(injector: Injector,
    ...
    private _xxxAppService: XxxServiceProxy,
  ...
  ngOnInit(): void {
    ...
    this.xxxs = new DataManager({
      url: this.baseUrl + '/api/services/app/Xxx/Get',
      adaptor: new UrlAdaptor()
  });
  }
  showCreateDialog() {
    this._modalService.open(
      CreateXxxDialogComponent
  ...
  delete(data): void {
    abp.message.confirm(
      this.l('DoYouWantToRemoveTheXxx', data.name),
      undefined,
      (result: boolean) => {
        if (result) {
          this._xxxAppService

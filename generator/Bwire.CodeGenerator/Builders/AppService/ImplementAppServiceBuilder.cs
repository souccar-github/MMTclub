...
namespace Bwire.CodeGenerator
{
    internal class ImplementAppServiceBuilder
    {
        ...
        private void GenerateGetQueryable(StringBuilder builder, string entityName, string paramName)
        {
            ...
            builder.AppendLine($"            IEnumerable<Read{entityName}Dto> data = ObjectMapper.Map<List<Read{entityName}Dto>>(list);");
            ...
            builder.AppendLine( "            {");
            builder.AppendLine($"                data = operations.PerformTake(data, dm.Take);");
            builder.AppendLine( "            }");
            builder.AppendLine($"            ");
